...
const MOCK_DATA: Record<string, TickerData> = {
  "005930.KS": {
    ...
    news: [
      { title: "Fed 파월 의장, 추가 금리 인상 가능성 일축", source: "Reuters", sourceUrl: "https://www.google.com/search?q=Fed+파월+금리+인상+일축+Reuters", time: "09:30", sentiment: "positive", axis: "macro" },
      { title: "삼성전자 HBM3E 양산 계획 발표", source: "연합뉴스", sourceUrl: "https://www.google.com/search?q=삼성전자+HBM3E+양산+연합뉴스", time: "10:15", sentiment: "positive", axis: "industry" },
      { title: "중국 상무부, 반도체 수출 규제 검토 보도", source: "FT", sourceUrl: "https://www.google.com/search?q=중국+반도체+수출+규제+FT", time: "11:00", sentiment: "negative", axis: "industry" },
      { title: "목표주가 하향 조정 — 키움증권", source: "증권사", sourceUrl: "https://www.google.com/search?q=삼성전자+목표주가+하향+키움증권", time: "13:30", sentiment: "negative", axis: "stock" },
      { title: "2분기 잠정 실적 발표 — 매출 전년 대비 +18%", source: "DART", sourceUrl: "https://dart.fss.or.kr/dsab001/main.do?autoSearch=true&textCrpNm=삼성전자", time: "16:00", sentiment: "positive", axis: "stock" },
    ],
    events: [
  ...
  GOOGL: {
    ...
    news: [
      ...
      { title: "AI 검색 광고 단가 상승 — 수익성 개선 기대", source: "eMarketer", sourceUrl: "https://www.google.com/search?q=AI+search+ad+pricing+eMarketer", time: "11:00", sentiment: "positive", axis: "industry" },
  ...
  "000660.KS": {
    ...
    news: [
      ...
      { title: "DRAM 가격 3개월 연속 상승", source: "DRAMeXchange", sourceUrl: "https://www.google.com/search?q=DRAM+가격+상승+DRAMeXchange", time: "11:00", sentiment: "positive", axis: "industry" },
